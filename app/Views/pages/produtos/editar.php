...
<div class="d-flex align-items-center gap-2 mb-4">
    ...
    <h1 class="mb-0 h4">Editar produto</h1>
</div>
            ...
            <div class="row g-3 mb-3">
                <div class="col-7">
                    ...
                    <input type="text" name="nome" id="nome" class="form-control"
                        value="<?= esc(old('nome', $produto['nome'])) ?>" required>
                </div>
                <div class="col-5">
                    ...
                    <input type="number" name="preco" id="preco" step="0.01" class="form-control"
                        value="<?= esc(old('preco', $produto['preco'])) ?>" required>
                </div>
            </div>
            ...
            <div class="row g-3 mb-4">
                <div class="col-6">
                    ...
                    <select name="categoria" id="categoria" class="form-select">
                        <option value="lanches" <?= old('categoria', $produto['categoria']) === 'lanches' ? 'selected' : '' ?>>Lanches</option>
                        <option value="bebidas" <?= old('categoria', $produto['categoria']) === 'bebidas' ? 'selected' : '' ?>>Bebidas</option>
                    </select>
                </div>
                <div class="col-6">
                    <?php if (!empty($produto['foto'])): ?>
                        <label class="form-label small fw-semibold">Foto atual</label>
                        <div class="mb-2">
                    ...
                    <label for="foto" class="form-label small fw-semibold">
                        <?= !empty($produto['foto']) ? 'Trocar foto' : 'Foto' ?>
                    </label>
