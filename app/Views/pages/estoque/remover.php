...
<div class="d-flex align-items-center gap-2 mb-4">
    ...
    <h1 class="mb-0 h4">Remover do estoque</h1>
</div>
    ...
    <div class="card shadow-sm" style="border-top:4px solid #dc3545;border-radius:.5rem">
        <div class="card-body p-4">
            <form action="<?= site_url('estoque/salvar') ?>" method="post">
                ...
                <div class="mb-3">
                    <label for="quantidade" class="form-label small fw-semibold">Quantidade a remover</label>
                    <input type="number" name="quantidade" id="quantidade" class="form-control"
                        value="<?= old('quantidade') ?? 1 ?>" min="1" required>
                </div>
                <div class="mb-3">
                    <label for="fornecedor" class="form-label small fw-semibold">Motivo / Destino</label>
                ...
                <div class="d-flex gap-2">
                    <button type="submit" class="btn btn-danger fw-semibold">
                        <i class="fa-solid fa-minus me-1"></i>Remover
                    </button>
